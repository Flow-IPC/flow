...
set(DOC_DOXYGEN_VERSION1 1.9.3)
set(DOC_DOXYGEN_VERSION2 1.9.4)
# CAUTION: If you decide to increase DOC_DOXYGEN_VERSION* range: Carefully ensure you've properly modified
# doc_generate() below.  See inside it.
find_package(Doxygen ${DOC_DOXYGEN_VERSION1} REQUIRED dot)
message(STATUS "Doxygen version [${DOXYGEN_VERSION}] (+ deps like `dot`) found.")
if((${DOXYGEN_VERSION} STREQUAL ${DOC_DOXYGEN_VERSION1}) OR (${DOXYGEN_VERSION} STREQUAL ${DOC_DOXYGEN_VERSION2}))
  message(STATUS
          "That *exact* version = what we wanted (one of: ${DOC_DOXYGEN_VERSION1}, ${DOC_DOXYGEN_VERSION2}).  Good.")
else()
  message(WARNING "Doxygen version [${DOXYGEN_VERSION}] found; we require at least [${DOC_DOXYGEN_VERSION1}]; but "
                    "to guarantee the proper output we ideally want *exactly* that version or *exactly* "
                    "[${DOC_DOXYGEN_VERSION2}].  Unfortunately Doxygen "
...
function(doc_generate full_else_public)
  ...
  if(full_else_public)
    ...
    # a graph for each documented class showing the direct and indirect implementation
    # dependencies (inheritance, containment, and class references variables) of the
    # class with other documented classes. Explicit enabling a collaboration graph,
    # when COLLABORATION_GRAPH is set to NO, can be accomplished by means of the
    # command \collaborationgraph. Disabling a collaboration graph can be accomplished
    # by means of the command \hidecollaborationgraph.
    # The default value is: YES.
    # OVERRIDING DEFAULT: Without containment/composition -- which is mostly expressed
    # in the private-member including docs (not this public API doc) -- this is pretty
    # useless.  Plus as of Doxygen 1.9.4 it seems to show some static private constants
    # in places (presumably a bug).
