...
{
  FLOW_ERROR_EXEC_AND_THROW_ON_ERROR(bool, async_wait, on_event, _1);
...
{
  FLOW_ERROR_EXEC_AND_THROW_ON_ERROR(bool, async_wait_finish, _1);
  // ^-- Call ourselves and return if err_code is null.  If got to present line, err_code is not null.
...
{
  FLOW_ERROR_EXEC_AND_THROW_ON_ERROR(bool, poll, _1);
  // ^-- Call ourselves and return if err_code is null.  If got to present line, err_code is not null.
...
{
  FLOW_ERROR_EXEC_AND_THROW_ON_ERROR(bool, swap_wanted_sockets, target_set, ev_type, _1);
  // ^-- Call ourselves and return if err_code is null.  If got to present line, err_code is not null.
...
{
  FLOW_ERROR_EXEC_AND_THROW_ON_ERROR(bool, clear_wanted_sockets, ev_type, _1);
  // ^-- Call ourselves and return if err_code is null.  If got to present line, err_code is not null.
...
{
  FLOW_ERROR_EXEC_AND_THROW_ON_ERROR(bool, events_wanted, _1);
  // ^-- Call ourselves and return if err_code is null.  If got to present line, err_code is not null.
...
{
  FLOW_ERROR_EXEC_AND_THROW_ON_ERROR(bool, events_detected, _1);
  // ^-- Call ourselves and return if err_code is null.  If got to present line, err_code is not null.
...
{
  FLOW_ERROR_EXEC_AND_THROW_ON_ERROR(bool, emit_result_sockets, target_set, ev_type, _1);
  // ^-- Call ourselves and return if err_code is null.  If got to present line, err_code is not null.
...
{
  FLOW_ERROR_EXEC_AND_THROW_ON_ERROR(bool, clear_result_sockets, ev_type, _1);
  // ^-- Call ourselves and return if err_code is null.  If got to present line, err_code is not null.
...
bool Event_set::clear(Error_code* err_code)
{
  ...
  FLOW_ERROR_EXEC_AND_THROW_ON_ERROR(bool, clear, _1);
  // ^-- Call ourselves and return if err_code is null.  If got to present line, err_code is not null.
...
{
  FLOW_ERROR_EXEC_AND_THROW_ON_ERROR(Event_set::Ptr, event_set_create, _1);
  // ^-- Call ourselves and return if err_code is null.  If got to present line, err_code is not null.
