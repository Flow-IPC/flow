...
void events_clear() { Lock_guard<mutex> lock{s_events_mtx}; s_events.clear(); }
void events_set(const string& str) { Lock_guard<mutex> lock{s_events_mtx}; s_events = str; }
string events() { Lock_guard<mutex> lock{s_events_mtx}; return s_events; }
